...
小号助力大号，抓包助力成功链接在代码239行修改为完整抓包链接，运行脚本提示 都黑号了，别薅了 为正常现象。
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/asd920/updateTeam/main/shareCodes/fcwb.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/asd920/updateTeam@main/shareCodes/fcwb.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/asd920/updateTeam@main/shareCodes/fcwb.json')
  }
