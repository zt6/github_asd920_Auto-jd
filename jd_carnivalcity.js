...
!(async () => {
  ...
  $.updatePkActivityIdRes = await getAuthorShareCode('https://raw.githubusercontent.com/asd920/updateTeam/main/shareCodes/jd_cityShareCodes.json')
  if (!$.updatePkActivityIdRes) {
    ...
    await $.wait(1000)
    $.updatePkActivityIdRes = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/asd920/updateTeam@main/shareCodes/jd_cityShareCodes.json')
  }
